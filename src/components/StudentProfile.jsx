...
export default function StudentProfile({name,enrollment_no,mentor,mobile_no,email}) {
                                ...
                                <div className="border-t border-gray-200">
                                    <dl>
                                        <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                            ...
                                            {/* <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">{props.data}</dd> */}
                                        </div>
